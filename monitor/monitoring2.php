...
$api_key = 'm783062617-c2aa5313f19820559b359d8f';
...
$monitor_started = date('F jS Y h:i:s A', $monitor_started);
...
if ($monitor_status == 0) { // Monitor is paused:
    ...
    if (empty($response->logs)) { // Downtime recorded:
        ...
        $monitor_last_downtime = date('F jS Y h:i:s A', $monitor_last_downtime);
